...
class DoubleMachineLearningRF(BaseModel):
    @staticmethod
    def name():
    ...
    def __init__(self, **kwargs):
        ...
        self.m_net = RandomForestRegressor(n_estimators=20, max_depth=20)
        self.l_net = RandomForestRegressor(n_estimators=20, max_depth=20)
